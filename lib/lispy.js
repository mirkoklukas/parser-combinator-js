...
/** 
 * Creates the AST in terms of nested lists
 * @function
 * @param  {string} src - The source code to be parsed.
 * @return {Array<Array>} - An AST in terms of nested lists.
 */
...
/** 
 * Parses the source code and evaluates it.
 * @function
 * @param  {string} src - The source code to be interpreted.
 * @return {object} - The result of the program.
 */
